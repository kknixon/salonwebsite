...
$( document ).ready( function(){
	...
	var mapIcon = ['./images/map-marker.png','./images/map-marker.png'];
	var mapLocations = [[28.2174479,-82.673687]];
	var mapInfoContent = ['Chelsea Loves Salon<br>44 St. West 32'];
		...
		googleMap: function(){
			...
			$( mapContainer ).each( function(){
				...
				var mapOptions = {
					...
					zoom: mapZoomLevel,
					center: new google.maps.LatLng(28.2174479,-82.673687),
				...
				for ( var i = 0; i < mapLocations.length; i++ ) {
					locationMarker = new google.maps.Marker({
						position: new google.maps.LatLng(28.2174479,-82.673687),
						map: map,
			...
			$( mapPanLink ).each( function(){
				...
				$( this ).on( 'click', function( event ){
					...
					var newLatLong = new google.maps.LatLng( 28.2174479,-82.673687 );
